...
from data_manager import RestaurantDataManager
...
class RestaurantConcierge:
    def __init__(self):
        ...
        self.query_cache = {}  # Cache for query analysis
    ...
    def chat(self, user_input: str) -> str:
        ...
        try:
            ...
            error_response = (
                ...
                "Could you please clarify or rephrase your request so I can better assist you?"
                "I'm here to help!"
            )
    ...
    def _gather_requirements(self, analysis: Dict, user_input: str) -> str:
        ...
        if analysis.get('is_special_event'):
            ...
            2. Asks 1 specific questions to gather the most important missing information
            3. Provides examples to make it easy for them to respond
            4. Keeps it brief and natural
    ...
    def _analyze_query(self, user_input: str) -> Dict:
        ...
        {{
            ...
            "number_requested": "explicit number of restaurants requested or null"
        }}
        ...
        - For 'number_requested': extract when user says 'show me 5 places' or '3 restaurants'
        ...
        try:
            ...
            self.query_cache[user_input] = analysis
    ...
    def _handle_special_event(self, analysis: Dict, user_input: str) -> str:
        ...
        # Get requirements
        number = analysis.get("number_requested") or analysis.get("limit") or 3
        ...
        # Take top 3 options
        top_options = group_friendly[:number]
    ...
    def _handle_search(self, analysis: Dict, user_input: str) -> str:
        ...
        self.last_recommendations = results[:number]
        
        # Generate response using LLM
        return self._generate_search_response(results[:number], analysis, user_input)
    ...
    def _handle_trending_query(self, analysis: Dict, user_input: str) -> str:
        ...
        self.last_recommendations = valid_results[:number]
        
        return self._generate_trending_response(valid_results[:number], analysis, user_input)
    ...
    def _generate_search_response(self, restaurants: List[Dict], 
        ...
        User Query: "{user_input}"
        Showing: {number} {'result' if number == 1 else 'results'}
        ...
        FORMAT for each:
        **🍽️ [Name]**
        • **Summary**: [Provide 2-3 sentences summary based on restaurant data like Rating, reviews, categories and visit tip]
    ...
    def _generate_trending_response(self, restaurants: List[Dict], 
        ...
        **🔥 [Restaurant Name]**
        • **Summary**: [Provide 2-3 sentences summary based on restaurant data with trend analysis and rating, review]
        • **Rating**: ⭐ [X.X] stars ([review_count] reviews)
        • **Hype Score**: 🔥 [XX/100] 
        • **Trend Score**: 📈 [XX/100] 
    ...
    def _handle_restaurant_info(self, analysis: Dict, user_input: str, 
        ...
        if info_type == "app_general":
            ...
            menu_items = [cat['title'] for cat in restaurant.get('categories', [])],
